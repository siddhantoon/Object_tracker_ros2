...
''' # Changes
classes = default=[0] in argeparse
...
def run(
	...
	tracker_list = []
	for i in range(bs):
		ff = [tracking_method, tracking_config, reid_weights, device, half]
